...
const guideLinks = [
  ...
  { href: "free-lemon-squeezy-webhook-test-tools.html", label: "Free Lemon Squeezy webhook test tools" },
  { href: "google-indexing-priority.html", label: "Google indexing priority queue" },
  { href: "tools/lemon-squeezy-live-checkout-launch-command.html", label: "Live checkout launch command builder" },
  ...
  { href: "guides/stripe-refund-webhook-rollback-nextjs.html", label: "Stripe refund webhook rollback in Next.js" },
  ...
  { href: "tools/lemon-squeezy-live-test-mode-checker.html", label: "Lemon Squeezy live/test mode checker" },
    ...
    <main className="shell">
      <header className="topbar">
        ...
        <div className="topbar__actions">
          ...
          <a className="ghost-link" href="tools/payment-webhook-test-plan-generator.html">
            Test plan
          </a>
          ...
          <a className="ghost-link" href="guides/lemon-squeezy-webhook-500-vercel-nextjs.html">
            500 fix
          </a>
      ...
      <section className="evidence-panel" aria-label="Pro Kit contents">
        <div className="evidence-panel__copy">
          ...
          <a className="inline-cta" href="tools/payment-webhook-test-plan-generator.html">
            Generate webhook test plan
          </a>
          ...
          <a className="inline-cta" href="guides/lemon-squeezy-webhook-500-vercel-nextjs.html">
            Fix Vercel webhook 500s
          </a>
