...
- Tool index: one scannable entry point for the standalone payload generator, signature verifier, idempotency key generator, Stripe fixture generator, full app, free sample, and Pro Kit preview.
